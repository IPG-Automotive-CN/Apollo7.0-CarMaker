...
bool HMTrackersObjectsAssociation::Associate(
  ...
  AINFO<<"fusion_tracks size = "<<fusion_tracks.size()<<"sensor_objects size = "<<sensor_objects.size();
  ...
  AINFO<<"donoting fusion_tracks size = "<<fusion_tracks.size();
  Eigen::Affine3d pose;
  ...
  ComputeAssociationDistanceMat(fusion_tracks, sensor_objects, ref_point,
                                ...
                                &association_mat);
  AINFO<<"ComputeAssociationDistanceMat fusion_tracks size = "<<fusion_tracks.size();
  ...
  AINFO<<"for1 fusion_tracks size = "<<fusion_tracks.size();
  ...
  AINFO<<"for2 fusion_tracks size = "<<fusion_tracks.size();
