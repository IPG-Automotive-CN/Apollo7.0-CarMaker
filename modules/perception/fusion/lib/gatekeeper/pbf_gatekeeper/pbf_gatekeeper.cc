...
bool PbfGatekeeper::AbleToPublish(const TrackPtr &track) {
  ...
  AINFO<<"invisible_in_lidar = "<<invisible_in_lidar
       <<"invisible_in_radar = "<<invisible_in_radar
       <<"invisible_in_camera = "<<invisible_in_camera;
